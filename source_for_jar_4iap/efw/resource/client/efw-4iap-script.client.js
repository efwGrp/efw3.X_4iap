...
EfwClient.prototype.fire = function(eventParams) {
	...
	efw.first_success = function(result) {
	...
	efw.first_error = function(errorResponse, errorType, errorMessage) {
...
EfwClient.prototype._fire2nd = function(eventId, paramsFormat, manualParams, servletUrl, uploadUrl) {
	...
	var callSecondAjax = function() {
		efw.second_success = function(result) {
		...
		efw.second_error = function(errorResponse, errorType, errorMessage) {
...
EfwClient.prototype._retryAjax = function() {
	EfwClient.prototype.alert(EfwClientMessages.prototype.CommunicationErrorException);//do not retry if it is 4iap.
};
